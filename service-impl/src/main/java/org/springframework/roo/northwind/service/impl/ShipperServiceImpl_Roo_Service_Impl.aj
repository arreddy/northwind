...
import org.springframework.roo.northwind.service.impl.ShipperServiceImpl;
...
privileged aspect ShipperServiceImpl_Roo_Service_Impl {
     ...
     * @return Map
     */
    public Map<String, List<MessageI18n>> ShipperServiceImpl.validate(Shipper shipper) {
     ...
     * @return Page
     */
    public Page<Shipper> ShipperServiceImpl.findAllByIdsIn(List<Long> ids, GlobalSearch globalSearch, Pageable pageable) {
