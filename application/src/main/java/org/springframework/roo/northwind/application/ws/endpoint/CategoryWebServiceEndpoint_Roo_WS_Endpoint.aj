...
package org.springframework.roo.northwind.application.ws.endpoint;
...
privileged aspect CategoryWebServiceEndpoint_Roo_WS_Endpoint {
    ...
    declare @type: CategoryWebServiceEndpoint: @WebService(endpointInterface = "org.springframework.roo.northwind.application.ws.api.CategoryWebService", portName = "CategoryWebServicePort", serviceName = "CategoryWebService", targetNamespace = "http://ws.northwind.roo.springframework.org/");
