...
import org.springframework.roo.northwind.model.Store_Roo_Jaxb_Entity;
...
privileged aspect Store_Roo_Jaxb_Entity {
    ...
    declare @type: Store: @XmlRootElement(name = "store", namespace = "http://ws.northwind.roo.springframework.org/");
