...
import org.springframework.roo.northwind.model.Supplier_Roo_Jaxb_Entity;
...
privileged aspect Supplier_Roo_Jaxb_Entity {
    ...
    declare @type: Supplier: @XmlRootElement(name = "supplier", namespace = "http://ws.northwind.roo.springframework.org/");
