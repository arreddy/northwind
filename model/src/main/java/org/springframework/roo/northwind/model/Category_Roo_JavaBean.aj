...
privileged aspect Category_Roo_JavaBean {
     ...
     * @return Category
     */
    public Category Category.setVersion(Long version) {
     ...
     * @return Category
     */
    public Category Category.setCreatedDate(Calendar createdDate) {
     ...
     * @return Category
     */
    public Category Category.setCreatedBy(String createdBy) {
     ...
     * @return Category
     */
    public Category Category.setModifiedDate(Calendar modifiedDate) {
     ...
     * @return Category
     */
    public Category Category.setModifiedBy(String modifiedBy) {
